...
His creative projects include the **Akhand Saga**, a multi-series science fantasy from an Indian-Asian perspective in an alternate universe, and the **Jaya** programming language. Jaya is envisioned as an indigenous programming language for India with Sanskrit at its core, with support for all Indian languages, making code accessible to everyone. 
...
Through a fictional account of the discovery of the number **Zero**, Salik talks about the power of ideas and stories, and how the stories we choose to believe in can ultimately dismantle ancient structures and change the world.

*   **Watch:** [TED.com](https://www.ted.com/talks/salik_shah_finding_a_home_for_your_story)
*   **Full Script:** [FINDING_A_HOME_FOR_YOUR_STORY.md](FINDING_A_HOME_FOR_YOUR_STORY.md)
...
*   **Board Member**, Plurality University (Paris) – A global network of artists and utopians.
*   **Ambassador**, Seasteading Institute – Promoting floating cities and alternative governance.
*   **Future of India Fellow** – Recognizing leadership in national civilizational design.
...
## 🎓 Education
*   **Film and Television Institute of India (FTII)**, Pune – Alumnus (2009).
